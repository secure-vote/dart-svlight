...
class BBFarmContract {
  final ContractAbi $abi = ContractAbi.fromJson(BBFARM_ABI, "BBFarm");
  EthereumAddress $addr;
  DeployedContract $contract;
  Web3Client $client;
  BBFarmContract(String address, Web3Client this.$client) {
