...
class BBFarmIfaceContract {
  final ContractAbi $abi = ContractAbi.fromJson(BBFARMIFACE_ABI, "BBFarmIface");
  EthereumAddress $addr;
  DeployedContract $contract;
  Web3Client $client;
  BBFarmIfaceContract(String address, Web3Client this.$client) {
