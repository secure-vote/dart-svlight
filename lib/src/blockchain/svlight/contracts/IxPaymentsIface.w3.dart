...
class IxPaymentsIfaceContract {
  final ContractAbi $abi =
      ContractAbi.fromJson(IXPAYMENTSIFACE_ABI, "IxPaymentsIface");
  EthereumAddress $addr;
  DeployedContract $contract;
  Web3Client $client;
  IxPaymentsIfaceContract(String address, Web3Client this.$client) {
