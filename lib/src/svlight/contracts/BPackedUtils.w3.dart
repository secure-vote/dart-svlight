...
class BPackedUtilsContract {
  final ContractAbi $abi =
      ContractAbi.fromJson(BPACKEDUTILS_ABI, "BPackedUtils");
  EthereumAddress $addr;
  DeployedContract $contract;
  Web3Client $client;
  BPackedUtilsContract(String address, Web3Client this.$client) {
