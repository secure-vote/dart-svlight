...
class ixBackendEventsContract {
  final ContractAbi $abi =
      ContractAbi.fromJson(IXBACKENDEVENTS_ABI, "ixBackendEvents");
  EthereumAddress $addr;
  DeployedContract $contract;
  Web3Client $client;
  ixBackendEventsContract(String address, Web3Client this.$client) {
