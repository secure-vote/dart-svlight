...
class RemoteBBFarmContract {
  final ContractAbi $abi =
      ContractAbi.fromJson(REMOTEBBFARM_ABI, "RemoteBBFarm");
  EthereumAddress $addr;
  DeployedContract $contract;
  Web3Client $client;
  RemoteBBFarmContract(String address, Web3Client this.$client) {
  ...
  Future<String> setBallotOwner(BigInt param_1, EthereumAddress param_2,
      Wallet wallet, TransactionNotPayable tx) async {
  ...
  Future<String> setDeprecated(
      BigInt param_1, Wallet wallet, TransactionNotPayable tx) async {
  ...
  Future<
      Tuple4<DynamicLengthArray<dynamic>, DynamicLengthArray<dynamic>,
          Uint8List, DynamicLengthArray<dynamic>>> getVotesBetween(
      BigInt ballotId, BigInt startTs, BigInt endTs,
      {EthereumAddress from}) async {
    var _f = $contract.function("getVotesBetween");
    var _params = <dynamic>[ballotId, startTs, endTs];
    var result = await $client.call(
        sender: _addrOrDefault(from),
        contract: $contract,
        function: _f,
        ...
        atBlock: BlockNum.current());
    return Tuple4(
        result[0] as DynamicLengthArray<dynamic>,
        result[1] as DynamicLengthArray<dynamic>,
        result[2] as Uint8List,
        result[3] as DynamicLengthArray<dynamic>);
  }
  ...
  Future<
      Tuple3<DynamicLengthArray<dynamic>, Uint8List,
          DynamicLengthArray<dynamic>>> getVotesBetweenFor(
      BigInt ballotId, BigInt startTs, BigInt endTs, EthereumAddress voter,
      {EthereumAddress from}) async {
    var _f = $contract.function("getVotesBetweenFor");
    var _params = <dynamic>[ballotId, startTs, endTs, voter];
    var result = await $client.call(
        sender: _addrOrDefault(from),
        contract: $contract,
        function: _f,
        params: _params,
        atBlock: BlockNum.current());
    return Tuple3(result[0] as DynamicLengthArray<dynamic>,
        result[1] as Uint8List, result[2] as DynamicLengthArray<dynamic>);
  }
  ...
  Future<String> revealSeckey(BigInt param_1, Uint8List param_2, Wallet wallet,
      TransactionNotPayable tx) async {
  ...
  Future<String> setEndTime(BigInt param_1, BigInt param_2, Wallet wallet,
      TransactionNotPayable tx) async {
  ...
  Future<String> initBallot(
      Uint8List param_1,
      BigInt param_2,
      EthereumAddress param_3,
      EthereumAddress param_4,
      Uint8List param_5,
      Wallet wallet,
      TransactionNotPayable tx) async {
    var _f = $contract.function("initBallot");
    var _params =
        _f.encodeCall(<dynamic>[param_1, param_2, param_3, param_4, param_5]);
    var finalized = tx.finalize(
        data: _params,
        from: await wallet.privateKey.extractAddress(),
        to: $contract.address);
  ...
  Future<String> $constructor(
      Uint8List _namespace, Wallet wallet, TransactionNotPayable tx) async {
    var _f = $abi.functions.where((f) => f.name == "" && f.isConstructor).first;
    var _params = _f.encodeCall(<dynamic>[_namespace]);
    var finalized = tx.finalize(
        data: _params,
        from: await wallet.privateKey.extractAddress(),
        to: $contract.address);
