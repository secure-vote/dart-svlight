...
class ixPaymentEventsContract {
  final ContractAbi $abi =
      ContractAbi.fromJson(IXPAYMENTEVENTS_ABI, "ixPaymentEvents");
  EthereumAddress $addr;
  DeployedContract $contract;
  Web3Client $client;
  ixPaymentEventsContract(String address, Web3Client this.$client) {
